...
const lesson4: Lesson = {
  ...
  competitionQuestions: [
    ...
    { id: "l4-q9", points: 5,
      text: "A staircase has 10 steps. Each step is 20 cm high. A kangaroo can jump 3 steps at a time. Starting from the bottom, how many jumps does it take to reach the top?",
      ...
      correctLetter: "B",
      explanation: "Jump 1: steps 1-3. Jump 2: steps 4-6. Jump 3: steps 7-9. Jump 4: step 10 (top). It takes 4 jumps." },
    { id: "l4-q10", points: 5,
  ...
  homeworkItems: [
    ...
    { id: "l4-h3", type: "mcq", text: "A kangaroo jumps 4 metres each jump. It needs to cross a 30-metre river. How many jumps does it need?",
      svgDiagram: svgFrogJumps(0, 32, 4, 8),
      options: [{ letter: "A", text: "6" }, { letter: "B", text: "7" }, { letter: "C", text: "8" }, { letter: "D", text: "9" }, { letter: "E", text: "10" }],
      correctLetter: "C",
      explanation: "7 jumps = 28m (not enough). 8 jumps = 32m ≥ 30m. The kangaroo needs 8 jumps." },
